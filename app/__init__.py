...
def create_app():
    ...
    log_file_debug = os.path.join(logdir, 'debug.log')
    handler_debug = logging.FileHandler(log_file_debug)
    ...
    def log_request(response):
        ...
        app.logger.info('this request has been logged')

        app.logger.debug('this request has been logged - only DEBUG ')
